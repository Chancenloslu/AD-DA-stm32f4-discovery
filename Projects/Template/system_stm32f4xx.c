...
/******************************************************************************/
  ...
  { /* If HSE fails to start-up, the application will have wrong clock
    ...
    /* HCLK = SYSCLK / 1*/
    RCC->CFGR |= RCC_CFGR_HPRE_DIV1;	//AHB	at most 168Mhz
      
    /* PCLK2 = HCLK / 2*/
    RCC->CFGR |= RCC_CFGR_PPRE2_DIV2;	//APB2	168 / 2 = 84Mhz
    
    /* PCLK1 = HCLK / 4*/
    RCC->CFGR |= RCC_CFGR_PPRE1_DIV4;	//APB1  168 / 4 = 42Mhz
